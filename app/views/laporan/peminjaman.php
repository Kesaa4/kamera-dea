...
<div class="no-print" style="text-align: center; margin-top: 30px;">
    ...
    <a href="?url=laporan/peminjaman&dari=<?= $data['dari'] ?>&sampai=<?= $data['sampai'] ?>&status=<?= $data['status'] ?>&format=excel"
       style="padding: 10px 30px; background: #217346; color: white; border-radius: 5px; text-decoration: none; font-size: 16px; margin-left: 10px; display:inline-block;">
        📊 Export Excel
    </a>
